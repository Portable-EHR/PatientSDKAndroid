 ...
 */
public class DispensaryDetailCall extends AbstractEHRCall {

    private DispensaryDetail responseContent;

    {
        setClassCountable(false);
    }

    public DispensaryDetailCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
        super(serverRequest, completionHandler);
        onNew();
    }


    public DispensaryDetail getResponseContent() {
        return responseContent;
    }

    public void setResponseContent(DispensaryDetail responseContent) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        DispensaryDetailResponse response = parser.fromJson(json, DispensaryDetailResponse.class);
        ...
        if (null != response) {
            this.setResponseContent(response.getResponseContent());
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + DispensaryDetailCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
