...
import com.portableehr.patientsdk.nao.backend.consent.CreateOfferCall;
 ...
 */
public class PullSingleAppointmentCall extends AbstractEHRCall {

    private Appointment                     responseContent;
    private SingleAppointmentServerResponse serverResponse;

    public PullSingleAppointmentCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
        super(serverRequest, completionHandler);
        onNew();
    }

    public Appointment getResponseContent() {
        return responseContent;
    }

    public void setResponseContent(Appointment responseContent) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        SingleAppointmentServerResponse response = parser.fromJson(json, SingleAppointmentServerResponse.class);
    ...
    public SingleAppointmentServerResponse getServerResponse() {
    ...
    private final static String  CLASSTAG = kModulePrefix + "." + CreateOfferCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
