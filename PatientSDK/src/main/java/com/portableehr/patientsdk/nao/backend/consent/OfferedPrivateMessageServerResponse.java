 ...
 */
public class OfferedPrivateMessageServerResponse extends EHRServerResponse {

    OfferedPrivateMessage responseContent;
    ...
    public OfferedPrivateMessageServerResponse() {
        super();
        onNew();
    }
