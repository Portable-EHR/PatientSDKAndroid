...
public class UserActivationStateServerResponse extends EHRServerResponse {

    IBUserActivationState responseContent;
    ...
    public UserActivationStateServerResponse(){
        super();
        onNew();
    }
    ...
    private final static String  CLASSTAG       = EHRLibRuntime.kModulePrefix + "." + UserActivationStateServerResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
