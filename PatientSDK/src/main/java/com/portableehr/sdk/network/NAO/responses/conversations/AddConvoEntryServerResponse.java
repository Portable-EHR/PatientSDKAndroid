...
public class AddConvoEntryServerResponse extends EHRServerResponse {

    ConversationEntry responseContent;
    ...
    public AddConvoEntryServerResponse() {
        super();
        onNew();
    }
    ...
    private final static String CLASSTAG = EHRLibRuntime.kModulePrefix + "." + AddConvoEntryServerResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private String TAG;
