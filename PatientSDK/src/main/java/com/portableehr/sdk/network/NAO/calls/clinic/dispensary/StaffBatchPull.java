 ...
 */
public class StaffBatchPull extends AbstractEHRCall {

    private BatchStaffPullResult responseContent;

    {
        setClassCountable(false);
    }

    public StaffBatchPull(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        StaffBatchResponse response = parser.fromJson(json, StaffBatchResponse.class);
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + StaffBatchPull.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
