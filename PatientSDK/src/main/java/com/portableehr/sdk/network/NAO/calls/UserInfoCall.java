...
import com.portableehr.sdk.network.NAO.responses.UserInfoServerResponse;
...
public class UserInfoCall extends AbstractEHRCall {

    private IBUser responseContent;

    public UserInfoCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        UserInfoServerResponse response = parser.fromJson(json, UserInfoServerResponse.class);
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + UserInfoCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
