...
public class UserInfoServerResponse extends EHRServerResponse {
    ...
    private final static String  CLASSTAG       = EHRLibRuntime.kModulePrefix + "." + UserInfoServerResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
