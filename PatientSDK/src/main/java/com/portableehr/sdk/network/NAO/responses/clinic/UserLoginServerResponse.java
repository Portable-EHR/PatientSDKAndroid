...
public class UserLoginServerResponse extends EHRServerResponse {

    IBUser responseContent;
    ...
    public UserLoginServerResponse(){
        super();
        onNew();
    }
    ...
    private final static String  CLASSTAG       = EHRLibRuntime.kModulePrefix + "." + UserLoginServerResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
