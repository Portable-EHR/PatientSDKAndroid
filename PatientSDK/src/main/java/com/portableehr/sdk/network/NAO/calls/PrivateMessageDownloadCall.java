...
public class PrivateMessageDownloadCall extends AbstractEHRCall {

    IBPrivateMessage responseContent;

    public PrivateMessageDownloadCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
