...
public class DispensaryInfoCall extends AbstractEHRCall {

    private DispensaryInfo responseContent;

    {
        setClassCountable(false);
    }

    public DispensaryInfoCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
        super(serverRequest, completionHandler);
        onNew();
    }


    public DispensaryInfo getResponseContent() {
        return responseContent;
    }

    public void setResponseContent(DispensaryInfo responseContent) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        DispensaryInfoResponse response = parser.fromJson(json, DispensaryInfoResponse.class);
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + DispensaryInfoCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
