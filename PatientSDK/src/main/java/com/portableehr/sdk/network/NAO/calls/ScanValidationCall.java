...
public class ScanValidationCall extends AbstractEHRCall {

    private IBScanValidation responseContent;

    public ScanValidationCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        ScanValidationServerResponse response = parser.fromJson(json, ScanValidationServerResponse.class);
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + ScanValidationCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
