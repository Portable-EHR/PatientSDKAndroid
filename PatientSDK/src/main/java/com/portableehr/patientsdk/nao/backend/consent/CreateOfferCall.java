 ...
 */
public class CreateOfferCall extends AbstractEHRCall {

    private AccessState         responseContent;
    private OfferServerResponse serverResponse;

    public CreateOfferCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        OfferServerResponse response = parser.fromJson(json, OfferServerResponse.class);
    ...
    public OfferServerResponse getServerResponse() {
