...
public class CreateConvoCall extends AbstractEHRCall {

    private Conversation responseContent;

    public CreateConvoCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    private final static String CLASSTAG = kModulePrefix + "." + CreateConvoCall.class.getSimpleName();
    @GSONexcludeOutbound
    private String TAG;
