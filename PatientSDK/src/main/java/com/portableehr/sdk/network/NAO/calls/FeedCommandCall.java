...
import com.portableehr.sdk.network.NAO.responses.FeedCommandResponse;
 ...
 */
public class FeedCommandCall extends AbstractEHRCall {

    private IBFeedStatus responseContent;

    {
        setClassCountable(false);
    }

    public FeedCommandCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        FeedCommandResponse response = parser.fromJson(json, FeedCommandResponse.class);
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + FeedCommandCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
