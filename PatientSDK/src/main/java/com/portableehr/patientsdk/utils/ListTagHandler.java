...
public class ListTagHandler implements Html.TagHandler {
    ...
    public void handleTag(final boolean opening, final String tag, final Editable output, final XMLReader xmlReader) {
        if (UL_TAG.equalsIgnoreCase(tag)) {
            ...
            Log.d("ListTagHandler", "Found an unsupported tag " + tag);
        }
    }

    //region ListTag abstract
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + ListTagHandler.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
