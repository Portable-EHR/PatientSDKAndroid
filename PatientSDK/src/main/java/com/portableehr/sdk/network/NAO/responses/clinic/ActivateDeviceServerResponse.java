...
public class ActivateDeviceServerResponse extends EHRServerResponse {
    ...
    public ActivateDeviceServerResponse() {
        super();
        onNew();
    }
    ...
    private final static String  CLASSTAG       = EHRLibRuntime.kModulePrefix + "." + ActivateDeviceServerResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
