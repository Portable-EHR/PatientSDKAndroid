 ...
 */
public class ConfirmationStateServerResponse extends EHRServerResponse {
    ...
    public ConfirmationStateServerResponse() {
        super();
        onNew();
    }
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + ConfirmationStateServerResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
