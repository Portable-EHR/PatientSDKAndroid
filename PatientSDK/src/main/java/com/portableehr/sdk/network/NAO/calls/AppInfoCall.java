...
import com.portableehr.sdk.network.NAO.inbound.IBInfo;
import com.portableehr.sdk.network.NAO.responses.AppInfoServerResponse;
...
public class AppInfoCall extends AbstractEHRCall {

    private IBInfo responseContent;

    public AppInfoCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
        super(serverRequest, completionHandler);
        onNew();
    }

    public IBInfo getResponseContent() {
        return responseContent;
    }

    public void setResponseContent(IBInfo responseContent) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        AppInfoServerResponse response = parser.fromJson(json, AppInfoServerResponse.class);
