...
public class DevicesListResponse extends EHRServerResponse {
    ...
    private final static String  CLASSTAG       = EHRLibRuntime.kModulePrefix + "." + DevicesListResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
