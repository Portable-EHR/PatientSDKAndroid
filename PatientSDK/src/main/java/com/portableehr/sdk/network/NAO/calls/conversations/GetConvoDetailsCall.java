...
import com.portableehr.sdk.network.NAO.responses.conversations.CreateConvoServerResponse;
...
public class GetConvoDetailsCall extends AbstractEHRCall {

    private Conversation responseContent;

    public GetConvoDetailsCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        CreateConvoServerResponse response = parser.fromJson(json, CreateConvoServerResponse.class);
    ...
    private final static String CLASSTAG = kModulePrefix + "." + GetConvoDetailsCall.class.getSimpleName();
    @GSONexcludeOutbound
    private String TAG;
