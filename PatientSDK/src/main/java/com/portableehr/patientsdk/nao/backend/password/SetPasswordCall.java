package com.portableehr.patientsdk.nao.backend.password;
...
public class SetPasswordCall extends AbstractEHRCall {

    public SetPasswordCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    private final static String CLASSTAG = kModulePrefix + "." + SetPasswordCall.class.getSimpleName();
    @GSONexcludeOutbound
    private String TAG;
