...
public class UpdatePushTokenServerResponse extends EHRServerResponse {
    ...
    public UpdatePushTokenServerResponse() {
        super();
        this.onNew();
    }
    ...
    private final static String CLASSTAG = EHRLibRuntime.kModulePrefix + "." + UpdatePushTokenServerResponse.class.getSimpleName();
    @GSONexcludeOutbound
    private String TAG;
