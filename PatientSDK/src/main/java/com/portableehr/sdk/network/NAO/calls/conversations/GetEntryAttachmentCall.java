...
public class GetEntryAttachmentCall extends AbstractEHRCall {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        GetEntryAttachmentServerResponse response = parser.fromJson(json, GetEntryAttachmentServerResponse.class);
    ...
    private final static String CLASSTAG = kModulePrefix + "." + GetEntryAttachmentCall.class.getSimpleName();
    @GSONexcludeOutbound
    private String TAG;
