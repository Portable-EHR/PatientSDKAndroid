 ...
 */
public class GetOfferCall extends AbstractEHRCall {

    private AccessState         responseContent;
    private OfferServerResponse serverResponse;

    public GetOfferCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    private final static String  CLASSTAG = kModulePrefix + "." + GetOfferCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
