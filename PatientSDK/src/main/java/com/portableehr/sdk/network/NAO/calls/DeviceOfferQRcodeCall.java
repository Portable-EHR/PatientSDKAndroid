...
import com.portableehr.sdk.network.NAO.responses.DeviceQRcodeServerResponse;
...
public class DeviceOfferQRcodeCall extends AbstractEHRCall {
    public IBDeviceQRcode responseContent;

    public DeviceOfferQRcodeCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        DeviceQRcodeServerResponse response = parser.fromJson(json, DeviceQRcodeServerResponse.class);
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + DeviceOfferQRcodeCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
