 ...
 */
public class FulfillRequestCall extends AbstractEHRCall {

    private AccessState                  responseContent;
    private FulfillRequestServerResponse serverResponse;

    public FulfillRequestCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        FulfillRequestServerResponse response = parser.fromJson(json, FulfillRequestServerResponse.class);
    ...
    public FulfillRequestServerResponse getServerResponse() {
    ...
    private final static String  CLASSTAG = kModulePrefix + "." + FulfillRequestCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
