 ...
 */
public class FulfillOfferCall extends AbstractEHRCall {

    private AccessState                responseContent;
    private FulfillOfferServerResponse serverResponse;

    public FulfillOfferCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        FulfillOfferServerResponse response = parser.fromJson(json, FulfillOfferServerResponse.class);
    ...
    public FulfillOfferServerResponse getServerResponse() {
    ...
    private final static String  CLASSTAG = kModulePrefix + "." + FulfillOfferCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
