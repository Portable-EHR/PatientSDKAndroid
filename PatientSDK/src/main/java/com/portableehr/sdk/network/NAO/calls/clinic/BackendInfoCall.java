...
public class BackendInfoCall extends AbstractEHRCall {

    private BackendInfo responseContent;

    {
        setClassCountable(false);
    }

    public BackendInfoCall(EHRServerRequest serverRequest, ICompletionHandler completionHandler) {
        super(serverRequest, completionHandler);
        onNew();
    }


    public BackendInfo getResponseContent() {
        return responseContent;
    }

    public void setResponseContent(BackendInfo responseContent) {
    ...
    public EHRRequestStatus parse(String json) {
        ...
        BackendInfoResponse response = parser.fromJson(json, BackendInfoResponse.class);
    ...
    private final static String  CLASSTAG       = kModulePrefix + "." + BackendInfoCall.class.getSimpleName();
    @GSONexcludeOutbound
    private              String  TAG;
